...
public class ResearchService {
    ...
    public String processContent(ResearchRequest researchRequest) {
        logger.info("Processing research request: operation={}, contentLength={}",
                ...
                researchRequest != null && researchRequest.getContent() != null ? researchRequest.getContent().length()
                        : 0);
        ...
        try {
            ...
            return webClient.post()
                    ...
                    .onErrorMap(WebClientResponseException.class, ex -> {
                        ...
                        logger.error("Gemini API call failed: status={}, body={}, message={}", status,
                    ...
                    .onErrorMap(Exception.class, ex -> {
                        ...
                        return new ResearchServiceException(
                                "Unexpected error during Gemini API call. Please try again later.", ex);
                    })
                    .block();
            ...
            logger.error("Gemini API call failed: status={}, body={}, message={}", status, ex.getResponseBodyAsString(),
                    ex.getMessage());
